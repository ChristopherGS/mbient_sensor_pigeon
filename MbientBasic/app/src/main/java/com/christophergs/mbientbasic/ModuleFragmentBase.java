...
public abstract class ModuleFragmentBase extends Fragment implements ServiceConnection {
    ...
    protected void showHelpDialog() {
        HelpOptionAdapter adapter= new HelpOptionAdapter(getActivity().getApplicationContext(), R.id.config_help_list);
    ...
    private void unsupportedModule() {
        new AlertDialog.Builder(getActivity()).setTitle(R.string.title_error)
                .setMessage(String.format("%s %s", getActivity().getApplicationContext().getString(sensorResId), getActivity().getString(R.string.error_unsupported_module)))
                .setCancelable(false)
